      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            className="hidden md:inline-flex px-4 py-2 rounded-full bg-accent-primary text-white font-mono text-[11px] tracking-[0.12em] uppercase hover:opacity-90 transition-opacity"
          >
            View CV
          </a>
